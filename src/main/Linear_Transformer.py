...
data_dir = '/home/careinfolab/Dr_Luo/Rohan/Linear_Attention/results/Linear_Transformer'
checkpoint_dir = '/home/careinfolab/Dr_Luo/Rohan/Linear_Attention/results/Linear_Transformer/checkpoints'
results_file = '/home/careinfolab/Dr_Luo/Rohan/Linear_Attention/results/Linear_Transformer/results.txt'
...
print("SOS ID:", en_tokenizer.encode("[SOS]").ids[0])
print("EOS ID:", en_tokenizer.encode("[EOS]").ids[0])
print("PAD ID:", en_tokenizer.encode("[PAD]").ids[0])
...
val_dataset.df.to_csv("/home/careinfolab/Dr_Luo/Rohan/Linear_Attention/Dataset/validation.csv", index=False)
...
def objective(trial):
    ...
    trainer = TransformerTrainEval(
        ...
        writer='runs/Linear_transformer'
    )
